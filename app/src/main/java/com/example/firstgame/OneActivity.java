        ...
        //    Log.d("myLogs", tab1_time[i]);
            ...
            registerForContextMenu(item);
              ...
              //      Log.d(LOG_TAG, "--- aniq i ni tutib oladi: ---"+i);
                 String text = "";
                    if(tab1_room[x]!=null){
                        text+=tab1_room[x]+"nci honada ";
                    }
                    text+=tab1_lesson[x]+" "+tab1_lesson_type[x]+" ";
                    if(tab1_teacher[x]!=null)
                        text+=tab1_teacher[x];
                       Log.d("myLogs", text);
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            ...
                            switch (menuindex) {
                                case 3:
                                    ...
                                    break;
                                case 2:
                                    Intent intent3 = new Intent(OneActivity.this, EditLesson.class);
                                    Log.d(LOG_TAG, "--- EditLessonga kirmoqchiman ---");
                                    intent3.putExtra("TabActivityDay", "day1");
                                    ...
                                    break;
                                case 1:
                                    Intent intent4 = new Intent(OneActivity.this, AddHomework.class);
