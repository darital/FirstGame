                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                ...
                                switch (menuindex) {
                                    case 3:
                                        ...
                                        //    finish();
                                        Intent intent2 = new Intent(SixActivity.this, MainActivity.class);
                                        startActivity(intent2);

                                        break;
                                    case 2:
                                        Intent intent3 = new Intent(SixActivity.this, EditLesson.class);
                                        Log.d(LOG_TAG, "--- EditLessonga kirmoqchiman ---");
                                        intent3.putExtra("TabActivityDay", "day6");
                                        ...
                                        break;
                                    case 1:
                                        Intent intent4 = new Intent(SixActivity.this, AddHomework.class);
