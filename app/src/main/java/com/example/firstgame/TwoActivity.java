                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                ...
                                switch (menuindex) {
                                    case 3:
                                        ...
                                        //    finish();
                                        Intent intent2 = new Intent(TwoActivity.this, MainActivity.class);
                                        startActivity(intent2);

                                        break;
                                    case 2:
                                        Intent intent3 = new Intent(TwoActivity.this, EditLesson.class);
                                        Log.d(LOG_TAG, "--- EditLessonga kirmoqchiman ---");
                                        intent3.putExtra("TabActivityDay", "day2");
                                        ...
                                        break;
                                    case 1:
                                        Intent intent4 = new Intent(TwoActivity.this, AddHomework.class);
